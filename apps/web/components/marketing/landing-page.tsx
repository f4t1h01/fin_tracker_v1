...
import {
  MarketingEffects,
  NavShell,
} from "@/components/marketing/marketing-effects";
import { ThemeToggle } from "@/components/theme-toggle";

const tickerItems = [
  "shared balance",
  "private & safe",
  "telegram instant entry",
  "live spending",
  "partner sync",
  "soft reminders",
];
...
const features = [
  {
    ...
    icon: "✦",
    title: "Instant Entry",
    text: "Step in from Telegram or the web without breaking the flow of your day.",
  },
  {
    index: "02",
    icon: "∞",
    title: "Partner Sync",
    text: "See the same financial picture and make decisions from one shared source of truth.",
  },
  {
    index: "03",
    icon: "◌",
    title: "Live Balance",
    text: "Track income, expenses, and your running couple balance in one calm workspace.",
  },
  {
    index: "04",
    icon: "♡",
    title: "Shared Goals",
    text: "Move from raw transactions to money habits that actually support your life together.",
  },
  {
    index: "05",
    icon: "↗",
    title: "Telegram Bot",
    text: "Open instantly from chat when speed matters, then keep working from the browser later.",
  },
  {
    index: "06",
    icon: "☉",
    title: "Private & Safe",
    text: "Keep credentials, pairing, and personal finance actions deliberate and protected.",
  },
];
...
const steps = [
  {
    number: "01",
    title: "Open",
    text: "Start from Telegram or from the website whenever you need it.",
  },
  {
    number: "02",
    title: "Track",
    text: "Capture income and spending in a shared financial picture.",
  },
  {
    number: "03",
    title: "Connect",
    text: "Pair with your partner using a couple code instead of awkward manual sharing.",
  },
  {
    number: "04",
    title: "Adjust",
    text: "Review, edit, filter, and refine the story behind your money together.",
  },
];
    ...
    <>
      ...
      <NavShell>
        ...
        <div className="nav-links">
          ...
          <Link className="nav-link" href="#couples">
            Couples
          </Link>
          <ThemeToggle />
          <PrimaryLink href="/auth">Get Started</PrimaryLink>
        </div>
      </NavShell>
        ...
        <section className="hero-section">
          <div className="container-shell hero-grid">
            <div className="hero-copy">
              <div data-seq="1">
                <Eyebrow>Couple Finance Tracker</Eyebrow>
              </div>
              <h1 className="hero-title" data-seq="2">
                A warmer way to see your <em>money together</em>.
              </h1>
              <p className="hero-description" data-seq="3">
                Duet helps couples track everyday spending, hold one shared
                picture, and move between Telegram and web without losing
                rhythm. It feels more like a printed financial journal than a
                noisy dashboard.
              </p>
              <div className="hero-ctas" data-seq="4">
                <PrimaryLink href="/auth">Open your workspace</PrimaryLink>
            ...
            <div className="section-header" data-reveal>
              <div>
                ...
                <h2 className="section-title">
                  Everything a couple needs to <em>thrive</em>.
                </h2>
              </div>
              <p className="section-note">
                A calm money workspace should help you feel aligned, not
                overwhelmed. Duet keeps the system clear, shared, and
                intentionally paced.
              </p>
            </div>
            ...
            <div className="feature-grid">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <p className="feature-copy" style={{ marginTop: 18 }}>
                    {feature.text}
                  </p>
                </article>
              ))}
            ...
            <div className="steps-grid">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <p className="step-copy" style={{ marginTop: 14 }}>
                    {step.text}
                  </p>
                </article>
              ))}
            ...
            {stats.map((stat) => (
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: `<div class='stat-value'>${stat.value}</div><div class='stat-label'>${stat.label}</div>`,
                }}
              />
            ))}
          </div>
          ...
          <div className="container-shell">
            <div className="connect-card" data-reveal>
              <div>
                ...
                <h2 className="section-title">
                  One code. Two people. A clearer <em>picture</em>.
                </h2>
                <p className="connect-copy" style={{ marginTop: 20 }}>
                  Share one short code, pair your spaces, and stop translating
                  your spending story manually. The system should make
                  connection feel intentional and elegant.
                </p>
              </div>
              <div className="connect-visual">
                ...
                <div className="avatar-circle avatar-circle--blush">M</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-block testimonial-section">
          ...
          <div className="container-shell" data-reveal>
            <blockquote className="testimonial-blockquote">
              For the first time, our budget stopped feeling like a spreadsheet
              fight and started feeling like one calm conversation.
            </blockquote>
        ...
        <section className="section-block cta-section">
          ...
          >
            ...
            <h2 className="cta-title">
              Build a gentler rhythm around your <em>money</em>.
            </h2>
            <p
              className="section-note"
              style={{ maxWidth: 460, margin: "20px auto 0" }}
            >
              Move between Telegram and the web, keep one shared balance in
              sight, and make every financial decision feel more aligned.
            </p>
            <div className="hero-ctas" style={{ justifyContent: "center" }}>
              <PrimaryLink href="/auth">Get Started</PrimaryLink>
              <SecondaryLink href="/auth">Open workspace</SecondaryLink>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="footer-shell">
          ...
          {footerColumns.map((column) => (
            <div key={column.title}>
              ...
              {column.links.map((link) => (
                <a className="footer-link" href="#top" key={link}>
                  {link}
                </a>
              ))}
            </div>
        ...
        <div className="container-shell footer-bottom">
          ...
          <span>
            Made for two people, one picture, and a little more ♥ calm.
          </span>
        </div>
      </footer>
    </>
