      ...
      <header className="soft-rise mb-8 grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4">
        <div className="min-w-0 space-y-4">
          ...
          <div>
            ...
            <h1 className="mt-5 font-[family-name:var(--font-heading)] text-[clamp(38px,4vw,56px)] font-light leading-[1.08]">Smart household inventory.</h1>
            <p className="body-muted mt-3 max-w-2xl text-sm">Track stock by place, let the system project recurring use, and surface the items that need attention first.</p>
          </div>
        </div>
