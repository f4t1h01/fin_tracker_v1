                    ...
                    {activeFeature === "menu" ? (
                      <div className="flex flex-col items-center justify-center gap-4 py-4">
                        ...
                        <button
                          type="button"
                          aria-disabled="true"
                          className="w-full cursor-not-allowed rounded-[24px] border border-dashed border-[rgba(201,168,76,0.18)] bg-[var(--surface-glass-strong)] px-5 py-5 text-left opacity-80"
                        >
                          <span className="flex items-start gap-4">
