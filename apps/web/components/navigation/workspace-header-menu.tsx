...
export function WorkspaceHeaderMenu({ className }: WorkspaceHeaderMenuProps) {
  ...
  return (
    <div ref={menuRef} className={cn("relative isolate z-[140] shrink-0", className)}>
      ...
      <div
        className={cn(
          "absolute right-0 top-full z-[145] mt-3 w-[min(22rem,calc(100vw-2rem))]",
      ...
      >
        <div className="relative">
          <div
            className={cn(
              "absolute inset-0 rounded-[24px] border border-[rgba(201,168,76,0.14)] shadow-[0_24px_56px_rgba(26,20,16,0.16)] bg-[color-mix(in_srgb,var(--surface-glass)_92%,transparent)] backdrop-blur-[14px] backdrop-saturate-150 transition-opacity duration-150 ease-out",
              isOpen ? "opacity-100" : "opacity-0"
            )}
          />
          <div
            className={cn(
              "relative overflow-hidden rounded-[24px] border border-[rgba(201,168,76,0.14)] bg-[color-mix(in_srgb,var(--surface-glass)_12%,transparent)] shadow-[0_24px_56px_rgba(26,20,16,0.16)] transition-[opacity,transform] duration-300 ease-out",
